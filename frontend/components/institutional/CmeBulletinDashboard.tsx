    ...
    <>
      ...
      <div className="space-y-3">
        ...
        <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <UnavailablePanel
            title="Gamma / GEX"
            reason="O boletim não fornece Gamma. O engine não foi executado e nenhum valor foi estimado."
          />
          <UnavailablePanel
          ...
          <UnavailablePanel
            title="Snapshot"
            reason="Snapshots estão desabilitados para a elegibilidade open_interest_only, evitando preencher campos institucionais ausentes."
          />
        </section>
